...
*/
    ...
    */
        function showExpressInstall(att, par, replaceElemIdStr, callbackFn) {
            ...
            if (obj) {
                ...
                var pt = ua.ie ? "ActiveX" : "PlugIn", fv = "MMredirectURL=" + encodeURIComponent(win.location.toString().replace(/&/g, "%26")) + "&MMplayerType=" + pt + "&MMdoctitle=" + doc.title;
    ...
    */
        function createSWF(attObj, parObj, id) {
            ...
            if (el) {
                var o = ua.ie ? createElement("div") : createElement(OBJECT), attr, attr_lower, param;
                        ...
                        if (flashvarsObj && typeof flashvarsObj === OBJECT) {
                            for (var k in flashvarsObj) {
                                ...
                                if (flashvarsObj.hasOwnProperty(k)) {
                                    var key = encodeURI_enabled ? encodeURIComponent(k) : k, value = encodeURI_enabled ? encodeURIComponent(flashvarsObj[k]) : flashvarsObj[k];
                                    if (typeof par.flashvars != UNDEF) {

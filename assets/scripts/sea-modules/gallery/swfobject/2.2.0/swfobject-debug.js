 ...
 *  @author: [http://code.google.com/p/swfobject/] 
 *  @date: 2013-11-09 
 */
define("gallery/swfobject/2.2.0/swfobject-debug", [], function(require, exports, module) {
...
*/
	...
	*/
        ua = function() {
            ...
            ie = !+"1", // feature detection based on Andrea Giammarchi's solution: http://webreflection.blogspot.com/2009/01/32-bytes-to-know-if-your-browser-is-ie.html
	...
	*/
        ...
        /** 2013.11.07 @tony
	 * [objectUnsupported 提示安装flash player]
	 * @param  {[String]} id [需要替换为提示内容的id]
	 * @return {[Object]} prompt [替换内容的对象]
	 */
        function objectUnsupported(id) {
            var el = getElementById(id), prompt = createElement("a");
            prompt.className = "object-unsupported";
            prompt.setAttribute("href", el.getAttribute("data-download-flashplayer") || "http://get.adobe.com/cn/flashplayer/");
            prompt.setAttribute("title", "点击安装Flash Player插件");
            prompt.innerHTML = [ '<span class="object-unsupported-ctn">', "请先安装Flash Player插件", "<br />", "让你的浏览器与我们的精彩同步！", "</span>" ].join("");
            el.parentNode.replaceChild(prompt, el);
            return prompt;
        }
                ...
                if (ua.w3 && !(ua.wk && ua.wk < 312) && swfUrlStr && replaceElemIdStr && widthStr && heightStr && swfVersionStr) {
                    ...
                    addDomLoadEvent(function() {
                        ...
                        if (hasPlayerVersion(swfVersionStr)) {
                            ...
                            // 2013.11.07 @tony
                            // 增加提示安装Flash Player
                            objectUnsupported(replaceElemIdStr);
                        }
                        if (callbackFn) {
